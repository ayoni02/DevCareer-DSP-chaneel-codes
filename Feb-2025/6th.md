...
- Don't worry about the second function in your `find_in_array` function, it's preloaded.
- All you have to do is figure out how to make your `find_in_array` itself work.
- If you want to drop any answers, click on the question and drop it in the thread of the question.